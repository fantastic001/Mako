...
LOG_FILE="logs/project_subproject_tasks_delete.log"
do_test() 
{
	set -x 
...
log_error() 
{
	echo "TEST FAILED: project_subproject_tasks_delete" >> $LOG_FILE
...
echo "Executing test project_subproject_tasks_delete"
echo > $LOG_FILE
