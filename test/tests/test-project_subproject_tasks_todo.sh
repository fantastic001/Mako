...
LOG_FILE="logs/project_subproject_tasks_todo.log"
do_test() 
{
	set -x 
...
log_error() 
{
	echo "TEST FAILED: project_subproject_tasks_todo" >> $LOG_FILE
...
echo "Executing test project_subproject_tasks_todo"
echo > $LOG_FILE
