...
setup(
  name = 'mako',
  packages = ['mako', 'mako.lib', "mako.lib.schedule", "mako.lib.schedule.formats", "mako.lib.ams", "mako.lib.ams.actions", "mako.lib.reporting", "mako.lib.database", "mako.desktop"], # this must be the same as the name above
  version = '0.1',
