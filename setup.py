...
setup(
  name = 'mako',
  packages = ['mako', 'mako.lib', "mako.lib.schedule", "mako.lib.schedule.formats", "mako.lib.ams", "mako.lib.ams.actions", "mako.lib.reporting", "mako.lib.reporting.month", "mako.lib.reporting.quarter", "mako.lib.database", "mako.desktop", "mako.lib.table"], # this must be the same as the name above
  version = '0.2',
